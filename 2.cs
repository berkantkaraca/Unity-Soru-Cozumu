...
// "Time: 45" metnini ekranın tam ortasına yerleştirin. 
// Metnin genişliği 60 piksel, yüksekliği 20 piksel olacak şekilde ayarlayın.
using UnityEngine;
...
public class ScoreDisplay : MonoBehaviour
{
    void OnGUI()
    {
        ...
        GUI.Label(new Rect(Screen.width - 100 - 30, 20, 100, 20), "Level: 3"); // 30 piksel boşluk, 100 piksel label genişliği
